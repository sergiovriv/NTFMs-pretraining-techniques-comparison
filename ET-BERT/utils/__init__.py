...
from uer.utils.data import PopDataset, PopDataLoader
...
str2dataset = {"bert": BertDataset, "lm": LmDataset, "mlm": MlmDataset,
               ...
               "t5": T5Dataset, "cls": ClsDataset, "prefixlm": PrefixlmDataset, "poponly": PopDataset}
...
__all__ = ["CharTokenizer", "SpaceTokenizer", "BertTokenizer", "str2tokenizer",
           ...
           "PrefixlmDataLoader","PopDataLoader", "str2dataloader",
