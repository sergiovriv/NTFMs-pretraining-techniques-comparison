...
from uer.targets.poponly_target import PopOnlyTarget
...
str2target = {
    ...
    "nsp":      NspTarget,
    "poponly":  PopOnlyTarget,
}

__all__ = [
    "BertTarget", "MlmTarget", "LmTarget", "BilmTarget", "AlbertTarget",
    "Seq2seqTarget", "T5Target", "ClsTarget", "PrefixlmTarget", "NspTarget",
    "PopOnlyTarget", "str2target",
]
