...
def main():
    ...
    parser.add_argument("--pooling", choices=["mean", "max", "first", "last"], default="first",
                        help="Pooling type.")
    parser.add_argument("--target", choices=["bert", "lm", "mlm", "bilm", "albert", "seq2seq", "t5", "cls","poponly", "prefixlm"], default="bert",
    ...
    parser.add_argument("--prefix_lm_loss", action="store_true",
                        help="Si se activa, solo calcula la pérdida LM en los tokens del segmento 2.")
